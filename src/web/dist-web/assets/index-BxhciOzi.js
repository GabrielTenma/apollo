		...
		function A(e, r, i, a, o) {
			...
			if (S(e))
				for (var u = 0; u < e.length; u++)
					(a = e[u]), (s = l + ne(a, u)), (c += A(a, r, i, s, o));
			else if (((u = m(e)), typeof u === `function`))
				for (e = u.call(e), u = 0; !(a = e.next()).done; )
					(a = a.value), (s = l + ne(a, u++)), (c += A(a, r, i, s, o));
			else if (s === `object`) {
	...
	g = o((e) => {
		...
		function re(e) {
			...
			if (typeof e === `object`)
				switch (e.$$typeof) {
					...
					case ee:
						return (
							(t = e.displayName || null), t === null ? re(e.type) || `Memo` : t
						);
					case D:
		...
		function ge(e) {
			ue.current === e && (ce(le), ce(ue)),
				fe.current === e && (ce(fe), (Qf._currentValue = ie));
		}
		var _e, ve;
		function ye(e) {
			if (_e === void 0)
...
` +
		...
		function ze(e) {
			if (
				...
				F && typeof F.setStrictMode === `function`)
			)
				try {
		...
		function rt(e, t) {
			var n = t & -t;
			return (
				(n = n & 42 ? 1 : it(n)), (n & (e.suspendedLanes | t)) === 0 ? n : 0
			);
		}
		function it(e) {
			switch (e) {
		...
		var R = /[\n"\\]/g;
		function z(e) {
			return e.replace(R, (e) => `\\${e.charCodeAt(0).toString(16)} `);
		}
					...
					!Object.hasOwn(n, r) ||
						...
						(r.indexOf(`--`) === 0
							...
							: r === `float`
								...
								: (e[r] = ``));
				for (var a in t)
					(r = t[a]), Object.hasOwn(t, a) && n[a] !== r && Gt(e, a, r);
			} else for (var o in t) Object.hasOwn(t, o) && Gt(e, o, t[o]);
		}
		function qt(e) {
				...
				switch (((e = t.stateNode), t.type)) {
					case `input`:
						if (
							...
							for (
								n = n.querySelectorAll(`input[name="${z(``)}"][type="radio"]`),
									t = 0;
								t < n.length;
								t++
							) {
				...
				movementX: (e) =>
					`movementX` in e
						...
						: (e !== wn &&
								...
								(wn = e)),
							Sn),
				movementY: (e) => (`movementY` in e ? e.movementY : Cn),
			}),
			En = _n(Tn),
		...
		var Ln = _n(
				m({}, bn, {
					...
					locale: 0,
					getModifierState: In,
					charCode: (e) => (e.type === `keypress` ? mn(e) : 0),
					keyCode: (e) =>
		...
		function Lr(e) {
			...
			var t = Pr[e],
				n;
			for (n in t) if (Object.hasOwn(t, n) && n in Ir) return (Fr[e] = t[n]);
			return e;
		}
		...
		function ui(e, t, n, r, a, o) {
			...
			if (((r = e), typeof e === `function`)) si(e) && (s = 1);
				...
				a: switch (e) {
					case O:
						return (e = oi(31, n, t, a)), (e.elementType = O), (e.lanes = o), e;
					case y:
					...
					case x:
						return (
							(e = oi(12, n, t, a | 2)), (e.elementType = x), (e.lanes = o), e
						);
					case T:
						return (e = oi(13, n, t, a)), (e.elementType = T), (e.lanes = o), e;
					case E:
						return (e = oi(19, n, t, a)), (e.elementType = E), (e.lanes = o), e;
					default:
		...
		function gi(e, t) {
			if (typeof e === `object` && e) {
				var n = hi.get(e);
				return n === void 0
					? ((t = { value: e, source: t, stack: Ce(t) }), hi.set(e, t), t)
					: n;
			}
		...
		function Pa(e) {
			...
			function f(e, t, n) {
				if (
					...
					return (t = fi(``, e.mode, n)), (t.return = e), t;
				if (typeof t === `object` && t) {
					switch (t.$$typeof) {
						case _:
							return (
				...
				for (d = r(d); h < s.length; h++)
					(g = m(d, i, h, s[h], c)),
						g !== null &&
							...
							(u = g));
				return e && d.forEach((e) => t(i, e)), H && Ei(i, h), l;
			}
			function g(a, s, c, l) {
				...
				for (h = r(h); !v.done; g++, v = c.next())
					(v = m(h, a, g, v.value, l)),
						v !== null &&
							...
							d === null ? (u = v) : (d.sibling = v),
							(d = v));
				return e && h.forEach((e) => t(a, e)), H && Ei(a, g), u;
			}
			function b(e, r, o, c) {
				if (
					(typeof o === `object` &&
		...
		function xs(e, t, n, r, i) {
			...
			try {
				...
				Ms(e, t, { then: () => {}, status: `rejected`, reason: n }, pu());
			} finally {
				(N.p = a),
		...
		function Cs(e, t, n, r) {
			...
			var a = ws(e).queue;
			xs(e, a, t, ie, n === null ? Ss : () => (Ts(e), n(r)));
		}
		function ws(e) {
			var t = e.memoizedState;
			if (t !== null) return t;
		...
		var Rs = {
				...
				use: Mo,
				useCallback: (e, t) => (
					(Oo().memoizedState = [e, t === void 0 ? null : t]), e
				),
				useContext: Qi,
				useEffect: cs,
				...
				useLayoutEffect: (e, t) => os(4194308, 4, e, t),
				...
				useDebugValue: gs,
				useDeferredValue: (e, t) => ys(Oo(), e, t),
				useTransition: () => {
					var e = Wo(!1);
					return (
				...
				useMemoCache: No,
				useCacheRefresh: () => (Oo().memoizedState = ks.bind(null, U)),
				useEffectEvent: (e) => {
					var t = Oo(),
						n = { impl: e };
					return (
			...
			zs = {
				...
				useState: () => Fo(Po),
				useDebugValue: gs,
				useDeferredValue: (e, t) => bs(ko(), W.memoizedState, e, t),
				useTransition: () => {
					var e = Fo(Po)[0],
						t = ko().memoizedState;
			...
			switch (((t.lanes = 0), t.tag)) {
				case 16:
					a: {
						var r = t.pendingProps;
						if (
							((e = Ta(t.elementType)), (t.type = e), typeof e === `function`)
						)
							si(e)
		...
		function Lc(e, t, n) {
			...
			switch ((ki(t), t.tag)) {
				...
				case 6:
					if (e && t.stateNode != null) e.memoizedProps !== r && Mc(t);
						...
						if (((e = de.current), Ri(t))) {
							...
							(e = Bd(e).createTextNode(r)), (e[lt] = t), (t.stateNode = e);
					}
					return G(t), null;
				case 31:
				...
				case 4:
					return me(), e === null && Sd(t.stateNode.containerInfo), G(t), null;
				case 10:
		...
		var Ll = {
				...
				cacheSignal: () => Qi(ia).controller.signal,
			},
			...
			fu = null;
		function pu() {
			return K & 2 && Y !== 0 ? Y & -Y : M.T === null ? ot() : dd();
		}
		function mu() {
			if (Jl === 0)
				if (!(Y & 536870912) || H) {
		...
		function Bu() {
			if (iu === 4 || iu === 3) {
				...
				if (
					...
					at(n),
					(t = t.stateNode),
					F && typeof F.onCommitFiberRoot === `function`)
				)
					try {
		...
		function Uu() {
			...
			try {
				...
				if (
					...
					(K = c),
					id(0, !1),
					F && typeof F.onPostCommitFiberRoot === `function`)
				)
					try {
		...
		function Ku(e, t, n) {
			...
			r?.delete(t),
				...
				q === e &&
					(Y & n) === n &&
					(Wl === 4 || (Wl === 3 && (Y & 62914560) === Y && 300 > ke() - $l)
						? !(K & 2) && Su(e, 0)
						: (ql |= n),
					Yl === Y && (Yl = 0)),
				rd(e);
...
`,
		...
		function Nd(e, t, n, r, a, o) {
			switch (n) {
				...
				case `children`:
					typeof r === `string`
						? Ut(e, r)
						: (typeof r === `number` || typeof r === `bigint`) && Ut(e, ``);
					break;
				case `onScroll`:
					r != null && Q(`scroll`, e);
					break;
		...
		function wf(e, t, n) {
			...
			var r = bf;
			if (r && e && t) {
				var i = `link[rel="preload"][as="${z(t)}"]`;
				t === `image` && n && n.imageSrcSet
					? ((i += `[imagesrcset="${z(n.imageSrcSet)}"]`),
						typeof n.imageSizes === `string` &&
							(i += `[imagesizes="${z(n.imageSizes)}"]`))
					: (i += `[href="${z(e)}"]`);
				var a = i;
				switch (t) {
					case `style`:
		...
		function Tf(e, t) {
			...
			if (n && e) {
				var r = t && typeof t.as === `string` ? t.as : `script`,
					i = `link[rel="modulepreload"][as="${z(r)}"][href="${z(e)}"]`,
					a = i;
				switch (r) {
					case `audioworklet`:
					case `paintworklet`:
		...
		function If(e, t, n) {
			if ((t.count++, t.instance === null))
				switch (t.type) {
					case `style`: {
						var r = e.querySelector(`style[data-href~="${z(n.href)}"]`);
...
var y = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
	b = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
	x = {};
function S(e, t) {
...
var oe = Object.keys(te),
	se = class extends O {
		constructor(e, t, n, r) {
			let i = -1;
			if ((super(e, t), ce(this, `space`, r), typeof n === `number`))
				for (; ++i < oe.length; ) {
					const e = oe[i];
...
function P(e) {
	...
	for (const [r, i] of Object.entries(e.properties)) {
		const a = new se(r, e.transform(e.attributes || {}, r), i, e.space);
		e.mustUseProperty?.includes(r) && (a.mustUseProperty = !0),
			(t[r] = a),
			(n[D(r)] = r),
			(n[D(a.attribute)] = r);
	}
...
function xe(e, t) {
	...
	if (n.length > 4 && n.slice(0, 4) === `data` && be.test(t)) {
		if (t.charAt(4) === `-`) {
			const e = t.slice(5).replace(ye, Ce);
...
var we = ee([le, fe, me, he, ge], `html`),
	Te = ee([le, pe, me, he, ge], `svg`);
function Ee(e) {
	return e.join(` `).trim();
}
var De = o((_e, t) => {
...
`,
		...
		function g(e, t) {
			...
			function y() {
				...
				return (t) => ((t.position = new b(e)), C(), t);
			}
			function b(e) {
				(this.start = e),
	...
	Oe = o((e) => {
		var t = e?.__importDefault || ((e) => (e?.__esModule ? e : { default: e }));
	...
	ke = o((e) => {
		...
		var t = /^--[a-zA-Z0-9_-]+$/,
			...
			a = /^-(ms)-/,
			o = (e) => !e || r.test(e) || t.test(e),
			s = (_e, t) => t.toUpperCase(),
			c = (_e, t) => `${t}-`;
		e.camelCase = (e, t) => (
			t === void 0 && (t = {}),
			o(e)
	...
	Ae = o((e, t) => {
		var n = (
				e?.__importDefault || ((e) => (e?.__esModule ? e : { default: e }))
			)(Oe()),
			r = ke();
		function i(e, t) {
			var i = {};
...
function Ie(e) {
	return `${Re(e?.line)}:${Re(e?.column)}`;
}
function Le(e) {
	return `${Ie(e?.start)}-${Ie(e?.end)}`;
}
function Re(e) {
...
var ze = l(Ae(), 1),
	...
	Ve = new Map(),
	He = /[A-Z]/g,
	Ue = new Set([`table`, `tbody`, `thead`, `tfoot`, `tr`]),
	We = new Set([`td`, `th`]),
...
function Je(e, t, n) {
	...
	t.tagName.toLowerCase() === `svg` &&
		...
		((i = Te), (e.schema = i)),
		e.ancestors.push(t);
	let a = lt(e, t.tagName, !1),
		o = it(e, t),
		s = ot(e, t);
	return (
		Ue.has(t.tagName) &&
			(s = s.filter((e) => (typeof e === `string` ? !w(e) : !0))),
		et(e, o, a, t),
		tt(o, s),
		e.ancestors.pop(),
		(e.schema = r),
...
function Ze(e, t, n) {
	let r = e.schema,
		i = r;
	t.name === `svg` && r.space === `html` && ((i = Te), (e.schema = i)),
		e.ancestors.push(t);
	const a = t.name === null ? e.Fragment : lt(e, t.name, !0),
		o = at(e, t),
		s = ot(e, t);
	return (
		et(e, o, a, t),
...
function it(e, t) {
	...
	for (i in t.properties)
		if (i !== `children` && Be.call(t.properties, i)) {
			const a = st(e, i, t.properties[i]);
			if (a) {
				const [i, o] = a;
	...
	for (const r of t.attributes)
		if (r.type === `mdxJsxExpressionAttribute`)
			...
			if (r.value && typeof r.value === `object`)
				if (r.value.data?.estree && e.evaluater) {
...
function st(e, t, n) {
	...
	if (!(n == null || (typeof n === `number` && Number.isNaN(n)))) {
		if (
			(Array.isArray(n) && (n = r.commaSeparated ? v(n) : Ee(n)),
			r.property === `style`)
		) {
...
function ct(e, t) {
	try {
		...
		const n = t,
			r = new F("Cannot parse `style` attribute", {
		...
		throw (
			...
			(r.url = `${Ge}#cannot-parse-style-attribute`),
			r)
		);
	}
}
...
function ut(e, t) {
	const n = new F("Cannot handle MDX estrees without `createEvaluater`", {
		ancestors: e.ancestors,
		place: t,
		ruleId: `mdx-estree`,
		source: `hast-util-to-jsx-runtime`,
	...
	throw (
		...
		(n.url = `${Ge}#cannot-handle-mdx-estrees-without-createevaluater`),
		n)
	);
}
function dt(e) {
	let t = {},
		n;
	for (n in e) Be.call(e, n) && (t[ft(n)] = e[n]);
	return t;
}
function ft(e) {
	let t = e.replace(He, pt);
...
function Ot(e, t) {
	let n;
	for (n in t) {
		let r = (Et.call(e, n) ? e[n] : void 0) || (e[n] = {}),
			i = t[n],
			a;
		if (i)
			for (a in i) {
...
function Vt(e) {
	...
	for (; ++n < e.length; ) {
		let a = e.charCodeAt(n),
			o = ``;
		if (a === 37 && I(e.charCodeAt(n + 1)) && I(e.charCodeAt(n + 2))) i = 2;
		else if (a < 128)
...
function Kt(e) {
	...
	function _c(e) {
		if ((r++, t.containerState._closeFlow)) {
			...
			return (
				wt(t.events, a + 1, 0, t.events.slice(n)), (t.events.length = s), l(e)
			);
		}
		return s(e);
	}
	function _l(a) {
		if (r === n.length) {
			if (!i) return f(a);
			if (i.currentConstruct?.concrete) return m(a);
...
var Xt = { name: `attention`, resolveAll: Zt, tokenize: Qt };
function Zt(e, t) {
	let n = -1,
		r,
		i,
			...
			for (r = n; r--; )
				if (
					...
					$t(d, -c),
						...
						(l = Tt(
							l,
							Yt(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t),
						)),
						(l = Tt(l, [
							[`exit`, a, t],
							[`enter`, s, t],
...
var en = { name: `autolink`, tokenize: tn };
function tn(e, t, n) {
	let r = 0;
	return i;
	function i(t) {
	...
	function _o(e) {
		return e === 43 || e === 45 || e === 46 || I(e) ? ((r = 1), s(e)) : l(e);
	}
	function s(t) {
		return t === 58
			? (e.consume(t), (r = 0), c)
			: (t === 43 || t === 45 || t === 46 || I(t)) && r++ < 32
				? (e.consume(t), s)
				: ((r = 0), l(t));
	}
	function c(r) {
...
var ln = { name: `characterEscape`, tokenize: un };
function un(e, t, n) {
	return r;
	function r(t) {
		return (
...
var dn = { name: `characterReference`, tokenize: fn };
function fn(e, t, n) {
	let r = this,
		i = 0,
		a,
	...
	function _c(t) {
		return t === 35
			? (e.enter(`characterReferenceMarkerNumeric`),
				...
				l)
			: (e.enter(`characterReferenceValue`), (a = 31), (o = I), u(t));
	}
	function _l(t) {
		return t === 88 || t === 120
			? (e.enter(`characterReferenceMarkerHexadecimal`),
				...
				(o = It),
				u)
			: (e.enter(`characterReferenceValue`), (a = 7), (o = Ft), u(t));
	}
	function _u(s) {
		if (s === 59 && i) {
			const i = e.exit(`characterReferenceValue`);
			return o === I && !Ct(r.sliceSerialize(i))
				? n(s)
				: (e.enter(`characterReferenceMarker`),
					e.consume(s),
					e.exit(`characterReferenceMarker`),
		...
		return o(s) && i++ < a ? (e.consume(s), _u) : n(s);
	}
}
var pn = { partial: !0, tokenize: gn },
	mn = { concrete: !0, name: `codeFenced`, tokenize: hn };
function hn(e, t, n) {
	let r = this,
		...
		return t === s
			...
			: o < 3
				...
				: (e.exit(`codeFencedFenceSequence`),
					z(t) ? B(e, d, `whitespace`)(t) : d(t));
	}
	function d(n) {
		return n === null || L(n)
			? (e.exit(`codeFencedFence`), r.interrupt ? t(n) : e.check(pn, h, b)(n))
...
var _n = { name: `codeIndented`, tokenize: yn },
	vn = { partial: !0, tokenize: bn };
function yn(e, t, n) {
	const r = this;
	return i;
	function i(t) {
...
var xn = { name: `codeText`, previous: Cn, resolve: Sn, tokenize: wn };
function Sn(e) {
	let t = e.length - 4,
		n = 3,
		r,
...
var Tn = class {
	...
	pushMany(e) {
		this.setCursor(1 / 0), En(this.left, e);
	}
	unshift(e) {
...
function Dn(e) {
	...
	for (; ++n < u.length; ) {
		...
		if (r[0] === `enter`)
			r[1].contentType && (Object.assign(t, On(u, n)), (n = t[n]), (l = !0));
...
var kn = { resolve: jn, tokenize: Mn },
	An = { partial: !0, tokenize: Nn };
function jn(e) {
	return Dn(e), e;
}
function Mn(e, t) {
	...
	function i(t) {
		return t === null ? a(t) : L(t) ? e.check(An, o, a)(t) : (e.consume(t), i);
	}
	function _a(n) {
...
function Fn(e, t, n, r, i, a) {
	...
	function d(t) {
		return t === null || t === 91 || t === 93 || L(t) || s++ > 999
			? (e.exit(`chunkString`), u(t))
			: (e.consume(t), (c ||= !z(t)), t === 92 ? f : d);
	}
	function _f(t) {
...
var Rn = { name: `definition`, tokenize: Bn },
	zn = { partial: !0, tokenize: Vn };
function Bn(e, t, n) {
	let r = this,
		i;
	return a;
	...
	function _s(t) {
		return (
			(i = jt(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))),
			t === 58
...
var Hn = { name: `hardBreakEscape`, tokenize: Un };
function Un(e, t, n) {
	return r;
	function r(t) {
...
var Wn = { name: `headingAtx`, resolve: Gn, tokenize: Kn };
function Gn(e, t) {
	let n = e.length - 2,
		r = 3,
		i,
...
var qn =
	...
	Yn = { concrete: !0, name: `htmlFlow`, resolveTo: Qn, tokenize: $n },
	Xn = { partial: !0, tokenize: tr },
	Zn = { partial: !0, tokenize: er };
function Qn(e) {
	let t = e.length;
...
function $n(e, t, n) {
	...
	function _d(s) {
		return s === 33
			...
			: s === 47
				? (e.consume(s), (a = !0), h)
				: s === 63
					? (e.consume(s), (i = 3), r.interrupt ? t : M)
					: Mt(s)
	...
	function _f(a) {
		return a === 45
			...
			: a === 91
				...
				: Mt(a)
					? (e.consume(a), (i = 4), r.interrupt ? t : M)
					: n(a);
	}
	function _p(i) {
	...
	function _m(i) {
		return i === `CDATA[`.charCodeAt(s++)
			? (e.consume(i), s === 6 ? (r.interrupt ? t : D) : _m)
			: n(i);
	}
	function _h(t) {
	...
	function _g(s) {
		if (s === null || s === 47 || s === 62 || R(s)) {
			const c = s === 47,
				l = o.toLowerCase();
			return !c && !a && Jn.includes(l)
				? ((i = 1), r.interrupt ? t(s) : D(s))
				: qn.includes(o.toLowerCase())
		...
		return s === 45 || I(s)
			? (e.consume(s), (o += String.fromCharCode(s)), _g)
			: n(s);
	}
	function _(i) {
	...
	function _b(t) {
		return t === 45 || t === 46 || t === 58 || t === 95 || I(t)
			? (e.consume(t), _b)
			: x(t);
	}
	function x(t) {
	...
	function _ee(t) {
		return t === null || L(t) ? D(t) : z(t) ? (e.consume(t), _ee) : n(t);
	}
	function D(t) {
		return t === 45 && i === 2
			? (e.consume(t), k)
				...
				: t === 62 && i === 4
					...
					: t === 63 && i === 3
						...
						: t === 93 && i === 5
							? (e.consume(t), j)
							: L(t) && (i === 6 || i === 7)
								? (e.exit(`htmlFlowData`), e.check(Xn, ie, O)(t))
								: t === null || L(t)
	...
	function _re(t) {
		...
		return Mt(t) && o.length < 8
			? (e.consume(t), (o += String.fromCharCode(t)), _re)
			: D(t);
	}
	function _j(t) {
...
var nr = { name: `htmlText`, tokenize: rr };
function rr(e, t, n) {
	let r = this,
		i,
		a,
	...
	function _x(t) {
		return Mt(t) ? (e.consume(t), S) : n(t);
	}
	function _S(t) {
		return t === 45 || I(t) ? (e.consume(t), _S) : C(t);
	}
	function _C(t) {
		return L(t) ? ((o = _C), A(t)) : z(t) ? (e.consume(t), _C) : k(t);
	}
	function _w(t) {
		return t === 45 || I(t)
			? (e.consume(t), _w)
...
var ir = { name: `labelEnd`, resolveAll: cr, resolveTo: lr, tokenize: ur },
	ar = { tokenize: dr },
	or = { tokenize: fr },
	sr = { tokenize: pr };
function cr(e) {
...
function lr(e, t) {
	...
	return (
		...
		(s = Tt(s, e.slice(a + 1, a + r + 3))),
		(s = Tt(s, [[`enter`, u, t]])),
		(s = Tt(
			s,
			Yt(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t),
		)),
		(s = Tt(s, [[`exit`, u, t], e[o - 2], e[o - 1], [`exit`, l, t]])),
		(s = Tt(s, e.slice(o + 1))),
		(s = Tt(s, [[`exit`, c, t]])),
		wt(e, a, e.length, s),
		e
...
function ur(e, t, n) {
		...
		return a
			? a._inactive
				...
				: ((o = r.parser.defined.includes(
						jt(r.sliceSerialize({ start: a.end, end: r.now() })),
					)),
					e.enter(`labelEnd`),
					e.enter(`labelMarker`),
					e.consume(t),
	...
	function _c(t) {
		return t === 40
			? e.attempt(ar, u, o ? u : d)(t)
			: t === 91
				? e.attempt(or, u, o ? l : d)(t)
				: o
					? u(t)
					: d(t);
	}
...
var mr = { name: `labelStartImage`, resolveAll: ir.resolveAll, tokenize: hr };
function hr(e, t, n) {
	const r = this;
	return i;
	function i(t) {
...
var gr = { name: `labelStartLink`, resolveAll: ir.resolveAll, tokenize: _r };
function _r(e, t, n) {
	const r = this;
	return i;
	function i(t) {
...
var vr = { name: `lineEnding`, tokenize: yr };
function yr(e, t) {
	return n;
	function n(n) {
		return (
...
var br = { name: `thematicBreak`, tokenize: xr };
function xr(e, t, n) {
	let r = 0,
		i;
	return a;
...
var Sr = {
	...
	Cr = { partial: !0, tokenize: kr },
	wr = { partial: !0, tokenize: Dr };
function Tr(e, t, n) {
	let r = this,
		...
		if (
			...
			if (
				...
				return (
					...
					t === 42 || t === 45 ? e.check(br, n, l)(t) : l(t)
				);
			if (!r.interrupt || t === 49)
	...
	function _l(t) {
		return (
			...
			e.check(nn, r.interrupt ? n : u, e.attempt(Cr, f, d))
		);
	}
	function _u(e) {
...
function Er(e, t, n) {
	...
	function a(n) {
		return r.containerState.furtherBlankLines || !z(n)
...
var Ar = { name: `setextUnderline`, resolveTo: jr, tokenize: Mr };
function jr(e, t) {
	let n = e.length,
		r,
		i,
	...
	const t = this,
		n = e.attempt(
			...
			e.attempt(
				...
				B(
					e,
					e.attempt(this.parser.constructs.flow, i, e.attempt(kn, i)),
					`linePrefix`,
				),
			),
		);
...
var Fr = { resolveAll: zr() },
	Ir = Rr(`string`),
	Lr = Rr(`text`);
function Rr(e) {
	return { resolveAll: zr(e === `text` ? Br : void 0), tokenize: t };
	function t(t) {
		const n = this,
...
function Zr(e, t, n) {
	...
	function d(e) {
		return (
			...
			g(),
			o[o.length - 1] === null
				? (w(t, 0), (l.events = Yt(a, l.events, l)), l.events)
				: []
		);
	}
	function f(e, t) {
	...
	function _w(e, t) {
		e.resolveAll && !a.includes(e) && a.push(e),
			e.resolve &&
				wt(l.events, t, l.events.length - t, e.resolve(l.events.slice(t), l)),
...
function li(e) {
	...
	function a(e, t) {
		return n;
		function n(n) {
			s.call(this, e(n), n), t?.call(this, n);
		}
	}
	function o() {
	...
	function _s(e, t, n) {
		this.stack[this.stack.length - 1].children.push(e),
			...
			(e.position = { start: ui(t.start), end: void 0 });
	}
	function c(e) {
		return t;
		function t(t) {
			e?.call(this, t), l.call(this, t);
		}
	}
	function _l(e, t) {
		...
		if (r)
			r[0].type !== e.type &&
				(t ? t.call(this, e, r[0]) : (r[1] || pi).call(this, e, r[0]));
		else
			throw Error(
				"Cannot close `" +
					e.type +
	...
	function T(e) {
		...
		(!n || n.type !== `text`) &&
			((n = Te()),
			(n.position = { start: ui(e.start), end: void 0 }),
			t.push(n)),
			this.stack.push(n);
	}
	function E(e) {
	...
	function re(e) {
		...
		(n.label = ai(t)), (n.identifier = jt(t).toLowerCase());
	}
	function j() {
		const e = this.stack[this.stack.length - 1],
			t = this.resume(),
	...
	function oe(e) {
		const t = this.resume(),
			n = this.stack[this.stack.length - 1];
		(n.label = t),
			(n.identifier = jt(this.sliceSerialize(e)).toLowerCase()),
	...
	function ce(e) {
		let t = this.sliceSerialize(e),
			...
			r;
		n
			? ((r = At(t, n === `characterReferenceMarkerNumeric` ? 10 : 16)),
...
function Pi(e, t) {
	...
	if (n.length > 0) {
		const r = {
			...
			a = Me(t.children[1]),
			o = je(t.children[t.children.length - 1]);
...
function zi(e) {
	let t = String(e),
		...
		a = [];
	for (; r; )
		a.push(Bi(t.slice(i, r.index), i > 0, !0), r[0]),
...
function Vi(e, t) {
	const n = { type: `text`, value: zi(String(t.value)) };
	return e.patch(t, n), e.applyData(t, n);
}
function Hi(e, t) {
...
function Wi() {}
var Gi = typeof self === `object` ? self : globalThis,
	Ki = (e, t) => {
	...
	Qi = ([e, t]) => e === 0 && (t === `function` || t === `symbol`),
	$i = (e, t, n, r) => {
		const i = (e, t) => {
				const i = r.push(e) - 1;
				return n.set(t, i), i;
				...
				switch (o) {
					...
					case 5: {
						const t = [],
							n = i([o, t], r);
						for (const [n, i] of r)
							(e || !(Qi(Zi(n)) || Qi(Zi(i)))) && t.push([a(n), a(i)]);
						return n;
					}
					case 6: {
						const t = [],
							n = i([o, t], r);
						for (const n of r) (e || !Qi(Zi(n))) && t.push(a(n));
						return n;
					}
				}
				const { message: c } = r;
	...
	ea = (e, { json: t, lossy: n } = {}) => {
		const r = [];
		return $i(!(t || n), !!t, new Map(), r)(e), r;
	},
	ta =
		typeof structuredClone === `function`
			? (e, t) =>
					t && (`json` in t || `lossy` in t) ? qi(ea(e, t)) : structuredClone(e)
			: (e, t) => qi(ea(e, t));
function na(_e, t) {
...
function ia(e) {
	let t =
			typeof e.options.clobberPrefix === `string`
				? e.options.clobberPrefix
				: `user-content-`,
		n = e.options.footnoteBackContent || na,
		r = e.options.footnoteBackLabel || ra,
			...
			children: [
				{
					type: `element`,
					tagName: a,
					properties: { ...ta(o), id: `footnote-label` },
...
function la(e) {
	...
	function t(t, n, r) {
		return !!(
			da(t) && e.call(this, t, typeof n === `number` ? n : void 0, r || void 0)
		);
	}
}
function ua() {
...
function ya(e, t) {
	...
	function o(e, t) {
		...
		if (a.options.passThrough?.includes(n)) {
			if (`children` in e) {
			...
			for (; ++r < n.length; ) {
				...
				if (i) {
					if (
						r &&
						n[r - 1].type === `break` &&
						(!Array.isArray(i) && i.type === `text` && (i.value = wa(i.value)),
...
function xa(e, t) {
	...
	if (e?.data) {
		...
		typeof t === `string` &&
			...
			n.type === `element` && i && Object.assign(n.properties, ta(i)),
...
function Sa(e, t) {
	const n = t.data || {},
		r =
			`value` in t && !(_a.call(n, `hProperties`) || _a.call(n, `hChildren`))
...
var Ma = { basename: Na, dirname: Pa, extname: Fa, join: Ia, sep: `/` };
function Na(e, t) {
...
function Ia(...e) {
	let t = -1,
		n;
	for (; ++t < e.length; )
		za(e[t]), e[t] && (n = n === void 0 ? e[t] : `${n}/${e[t]}`);
...
var Ga = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`],
	Ka = class {
		constructor(e) {
			let t;
			(t = e
				? Ha(e)
					? { path: e }
					: typeof e === `string` || Xa(e)
						? { value: e }
						: e
				: {}),
				(this.cwd = `cwd` in t ? `` : Ba.cwd()),
				(this.data = {}),
				(this.history = []),
				(this.messages = []),
				this.value,
		...
		set basename(e) {
			Ja(e, `basename`),
				qa(e, `basename`),
				(this.path = Ma.join(this.dirname || ``, e));
		}
		get dirname() {
			return typeof this.path === `string` ? Ma.dirname(this.path) : void 0;
		}
		set dirname(e) {
			Ya(this.basename, `dirname`),
				(this.path = Ma.join(e || ``, this.basename));
		}
		get extname() {
		...
		set stem(e) {
			Ja(e, `stem`),
				qa(e, `stem`),
				(this.path = Ma.join(this.dirname || ``, e + (this.extname || ``)));
		}
		fail(e, t, n) {
...
function qa(e, t) {
	if (e?.includes(Ma.sep))
		throw Error(`\`${t}\` cannot be a path: did not expect \`${Ma.sep}\``);
}
function Ja(e, t) {
	...
	eo = new (class e extends Za {
		...
		data(e, t) {
			return typeof e === `string`
				? arguments.length === 2
					? (ro(`data`, this.frozen), (this.namespace[e] = t), this)
					: ($a.call(this.namespace, e) && this.namespace[e]) || void 0
				: e
					? (ro(`data`, this.frozen), (this.namespace = e), this)
					: this.namespace;
		}
		freeze() {
		...
		use(e, ...t) {
			...
			function a(e) {
				...
				o(e.plugins),
					e.settings &&
						(r.settings = (0, Qa.default)(!0, r.settings, e.settings));
			}
			function o(e) {
				let t = -1;
				if (e != null)
			...
			function s(e, t) {
				...
				if (i === -1) n.push([e, ...t]);
					...
					let [r, ...a] = t,
						o = n[i][1];
					ka(o) && ka(r) && (r = (0, Qa.default)(!0, o, r)),
						(n[i] = [e, r, ...a]);
				}
			}
		}
...
var U = gt(),
	W = l(d(), 1),
	uo = [],
	fo = { allowDangerousHtml: !0 },
	po = /^(https?|ircs?|mailto|xmpp)$/i,
	mo = [
...
function go(e) {
	const t = e.rehypePlugins || uo,
		n = e.remarkPlugins || uo,
		r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...fo } : fo;
	return eo().use(mi).use(n).use(Ea, r).use(t);
}
function _o(e) {
	const t = e.children || ``,
		n = new Ka();
...
function vo(e, t) {
	const n = t.allowedElements,
		...
		c = t.urlTransform || yo;
	for (const e of mo) Object.hasOwn(t, e.from) && ``;
	return (
		ga(e, l),
		Ke(e, {
			Fragment: U.Fragment,
	...
	function l(e, t, i) {
		...
		if (e.type === `element`) {
			let t;
			for (t in mt)
				if (Object.hasOwn(mt, t) && Object.hasOwn(e.properties, t)) {
...
function Io(e) {
	So(
		...
		[
			[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi, Lo],
			[/(?<=^|\s|\p{P}|\p{S})([-.\w+]+)@([-\w]+(?:\.[-\w]+)+)/gu, Ro],
		],
		{ ignore: [`link`, `linkReference`] },
	);
}
function Lo(_e, t, n, r, i) {
	let a = ``;
	if (
		!Vo(i) ||
		(/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !zo(n))
	)
		return !1;
	const o = Bo(n + r);
	if (!o[0]) return !1;
...
function $o(e) {
	let t = !1;
	return (
		e?.firstLineBlank && (t = !0),
		{
			handlers: { footnoteDefinition: n, footnoteReference: Zo },
			unsafe: [
...
`
						: ` `) +
						r.indentLines(r.containerFlow(e, a.current()), t ? ts : es),
				))),
			s(),
			o
		);
...
function is() {
	return {
		unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: ns }],
		handlers: { delete: ss },
	};
}
function as(e) {
...
function ps(e, _t, n, r) {
	const i = n.enter(`blockquote`),
		a = n.createTracker(r);
	a.move(`> `), a.shift(2);
	const o = n.indentLines(n.containerFlow(e, a.current()), ms);
	return i(), o;
}
function ms(e, _t, n) {
	return `>${n ? `` : ` `}${e}`;
...
function Os(e, _t, n, r) {
	let i = Ts(n),
		...
		l = c.charCodeAt(0),
		u = Ds(r.before.charCodeAt(r.before.length - 1), l, i);
	u.inside && (c = Es(l) + c.slice(1));
	const d = c.charCodeAt(c.length - 1),
		f = Ds(r.after.charCodeAt(0), d, i);
...
`,
	...
	return (
		/^[\t ]/.test(l) && (l = Es(l.charCodeAt(0)) + l.slice(1)),
		(l = l ? `${o} ${l}` : o),
...
function ec(e, _t, n, r) {
	return (
		e.children.some((e) => $s(e)) ? n.containerPhrasing : n.containerFlow
	).call(n, e, r);
}
function tc(e) {
...
function oc(_e, _t, n) {
	const r = (Js(n) + (n.options.ruleSpaces ? ` ` : ``)).repeat(ac(n));
...
function cc() {
	return {
		enter: { table: lc, tableData: pc, tableHeader: pc, tableRow: dc },
		exit: {
			codeText: mc,
			table: uc,
			tableData: fc,
...
`),
	...
	function _l(e, t) {
		return us(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
	}
	function _u(e, t, n) {
		let r = e.children,
			i = -1,
...
function xc(e, t, n, r) {
	const i = e.children[0],
		...
		s = n.createTracker(r);
	a && s.move(o);
	let c = sc.listItem(e, t, n, { ...r, ...s.current() });
...
function Sc() {
	return [Oo(), Qo(), rs(), cc(), _c()];
}
function Cc(e) {
	return { extensions: [ko(), $o(e), is(), gc(e), vc()] };
}
var wc = { tokenize: Lc, partial: !0 },
	Tc = { tokenize: Rc, partial: !0 },
	Ec = { tokenize: zc, partial: !0 },
	Dc = { tokenize: Bc, partial: !0 },
	Oc = { tokenize: Vc, partial: !0 },
	kc = { name: `wwwAutolink`, tokenize: Ic, previous: Hc },
	Ac = { name: `protocolAutolink`, tokenize: G, previous: Uc },
	jc = { name: `emailAutolink`, tokenize: Fc, previous: Wc },
	Mc = {};
function Nc() {
	return { text: Mc };
}
for (var Pc = 48; Pc < 123; )
	(Mc[Pc] = jc), Pc++, Pc === 58 ? (Pc = 65) : Pc === 91 && (Pc = 97);
(Mc[43] = jc),
	(Mc[45] = jc),
	(Mc[46] = jc),
	(Mc[95] = jc),
...
function Fc(e, t, n) {
	...
	return o;
	function o(t) {
		return !Gc(t) || !Wc.call(r, r.previous) || Kc(r.events)
			? n(t)
			: (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), s(t));
	}
	function s(t) {
		return Gc(t) ? (e.consume(t), s) : t === 64 ? (e.consume(t), c) : n(t);
	}
	function c(t) {
		return t === 46
			? e.check(Oc, u, l)(t)
...
function Ic(e, t, n) {
	...
	return i;
	function i(t) {
		return (t !== 87 && t !== 119) || !Hc.call(r, r.previous) || Kc(r.events)
			? n(t)
			: (e.enter(`literalAutolink`),
				e.enter(`literalAutolinkWww`),
				e.check(wc, e.attempt(Tc, e.attempt(Ec, a), n), n)(t));
	}
	function _a(n) {
...
function G(e, t, n) {
	...
	return o;
	function o(t) {
		return (t === 72 || t === 104) && Uc.call(r, r.previous) && !Kc(r.events)
			? (e.enter(`literalAutolink`),
	...
	function _l(t) {
		return t === null || Pt(t) || R(t) || zt(t) || Rt(t)
			? n(t)
			: e.attempt(Tc, e.attempt(Ec, u), n)(t);
	}
	function _u(n) {
	...
	function r(o) {
		return o === 33 ||
			...
			: o === 38
				...
				: o === 93
					? (e.consume(o), i)
					: o === 60 || o === null || R(o) || zt(o)
						? t(o)
						: n(o);
	}
	function _i(e) {
		return e === null || e === 40 || e === 91 || R(e) || zt(e) ? t(e) : r(e);
	}
	function _a(e) {
		return Mt(e) ? o(e) : n(e);
	}
...
function Gc(e) {
	return e === 43 || e === 45 || e === 46 || e === 95 || I(e);
}
function Kc(e) {
	let t = e.length,
		n = !1;
...
function Jc() {
	return {
		...
		text: {
			91: { name: `gfmFootnoteCall`, tokenize: Zc },
			93: {
...
function Yc(e, t, n) {
	...
	return s;
	function s(i) {
		if (!o?._balanced) return n(i);
		const s = jt(r.sliceSerialize({ start: o.end, end: r.now() }));
...
function Zc(e, t, n) {
	...
	function l(s) {
		if (a > 999 || (s === 93 && !o) || s === null || s === 91 || R(s))
			return n(s);
		if (s === 93) {
			e.exit(`chunkString`);
			const a = e.exit(`gfmFootnoteCallString`);
			return i.includes(jt(r.sliceSerialize(a)))
				? (e.enter(`gfmFootnoteCallLabelMarker`),
					e.consume(s),
					e.exit(`gfmFootnoteCallLabelMarker`),
...
function Qc(e, t, n) {
	...
	function u(t) {
		if (o > 999 || (t === 93 && !s) || t === null || t === 91 || R(t))
			return n(t);
		if (t === 93) {
			e.exit(`chunkString`);
			const n = e.exit(`gfmFootnoteDefinitionLabelString`);
			return (
				(a = jt(r.sliceSerialize(n))),
				e.enter(`gfmFootnoteDefinitionLabelMarker`),
				e.consume(t),
				e.exit(`gfmFootnoteDefinitionLabelMarker`),
...
function $c(e, t, n) {
	return e.check(nn, t, e.attempt(qc, t, n));
}
function el(e) {
			...
			if (
				...
				for (; r--; )
					if (
						...
						s && wt(o, o.length, 0, Yt(s, e.slice(r + 1, n), t)),
							wt(o, o.length, 0, [
								[`exit`, a, t],
								[`enter`, e[n][1], t],
								[`exit`, e[n][1], t],
...
var rl = class {
	...
	consume(e) {
		if ((this.map.sort((e, t) => e[0] - t[0]), this.map.length === 0)) return;
...
function ol() {
	return { flow: { null: { name: `table`, tokenize: sl, resolveAll: cl } } };
}
function sl(e, t, n) {
	let r = this,
		i = 0,
...
function cl(e, t) {
		...
		p[0] === `enter`
			...
			: m.type === `tableHead`
				...
				: m.type === `tableRow` || m.type === `tableDelimiterRow`
					? ((c = n),
						a[1] === 0
							? o[1] !== 0 && (d = ll(f, t, o, i, n, d))
							: ((o[0] = o[1]), (d = ll(f, t, a, i, n, d))),
						(i = 0))
					: i &&
						(m.type === `data` ||
							m.type === `tableDelimiterMarker` ||
	...
	for (
		c !== 0 && ul(f, t, c, l, u), f.consume(t.events), n = -1;
		++n < t.events.length;
	) {
		const e = t.events[n];
		e[0] === `enter` &&
			e[1].type === `table` &&
			(e[1]._align = al(t.events, n));
	}
	return e;
}
function ll(e, t, n, r, i, a) {
	...
	return (
		i !== void 0 &&
			((a.end = Object.assign({}, dl(t.events, i))),
			e.add(i, 0, [[`exit`, a, t]]),
			(a = void 0)),
		a
	);
...
var fl = { name: `tasklistCheck`, tokenize: ml };
function pl() {
	return { text: { 91: fl } };
}
function ml(e, t, n) {
	...
	function _s(r) {
		return L(r) ? t(r) : z(r) ? e.check({ tokenize: hl }, t, n)(r) : n(r);
	}
}
function hl(e, t, n) {
...
function vl(e) {
	...
	i.push(gl(n)), a.push(Sc()), o.push(Cc(n));
}
var yl = l(_()),
	bl = `table table-xs table-pin-rows table-pin-cols`;
function xl({ children: e }) {
	return (0, U.jsx)(`div`, {
		className: `my-4 w-full overflow-x-auto rounded-btn`,
		children: (0, U.jsx)(`table`, { className: bl, children: e }),
	});
}
function Sl({ children: e }) {
	return (0, U.jsx)(`th`, { className: `!text-wrap`, children: e });
}
function Cl({ children: e }) {
	return (0, U.jsx)(`td`, { className: `!text-wrap`, children: e });
}
function wl({ children: e }) {
	return (0, U.jsx)(`thead`, { children: e });
}
function Tl({ children: e }) {
	return (0, U.jsx)(`tbody`, { children: e });
}
function El({ children: e }) {
	return (0, U.jsx)(`tfoot`, { children: e });
}
function Dl({ children: e }) {
	return (0, U.jsx)(`tr`, { children: e });
}
function Ol({ children: e }) {
	return (0, U.jsx)(`p`, { children: e });
}
var kl = {
	table: xl,
	th: Sl,
	...
	return (
		(0, W.useEffect)(() => {
			(async () => {
				try {
					const e = await (
						await fetch(`http://localhost:3000/api/v1/openrouter/completion`)
					).json();
					if (e.success && Array.isArray(e.data))
						for (const n of e.data)
							n.name === `latest` && t(n.value),
								n.name === `previous` && r(n.value);
					console.debug(`Fetch OK:`, e);
				} catch (e) {
		...
		(0, U.jsx)(`div`, {
			className: `bg-base-100 py-8 sm:py-16 lg:py-24`,
			children: (0, U.jsx)(`div`, {
				...
				children: (0, U.jsxs)(`div`, {
					...
					children: [
						(0, U.jsx)(`div`, {
							className: `mb-12 space-y-4 sm:mb-16 lg:mb-24`,
							children: (0, U.jsx)(`div`, {
								children: (0, U.jsx)(`span`, {
									className: `badge badge-soft badge-primary rounded-full font-semibold`,
									children: `Apollo Watcher`,
								}),
							}),
						}),
						(0, U.jsx)(`div`, {
							...
							children: (0, U.jsxs)(`div`, {
								...
								children: [
									(0, U.jsx)(`h3`, {
										className: `text-base-content text-3xl font-semibold`,
										children: `Latest Completion`,
									}),
									(0, U.jsx)(ho, {
										remarkPlugins: [vl],
										components: kl,
										children: i
											? `Loading...`
											: e || `No latest completion available`,
									}),
									(0, U.jsx)(`hr`, { className: `border-base-content/20` }),
									(0, U.jsx)(`div`, {
										className: `space-y-4`,
										children: (0, U.jsxs)(`div`, {
											...
											children: [
												(0, U.jsx)(`span`, {
													className: `text-base-content w-22 font-semibold`,
													children: `Correlation:`,
												}),
												(0, U.jsx)(`span`, {
													className: `text-base-content/80`,
													children:
														e && n ? `Has previous` : `No previous data`,
												}),
											],
										}),
									}),
...
yl.createRoot(document.getElementById(`root`)).render(
	(0, U.jsx)(W.StrictMode, { children: (0, U.jsx)(jl, {}) }),
);
